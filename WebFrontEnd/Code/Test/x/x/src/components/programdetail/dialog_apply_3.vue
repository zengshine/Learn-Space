<template>
     <el-dialog  class="com-dialog dialog_apply_3" title="提交方案" :visible.sync="dialogVisible" width="50%"  @close="closeit" >
         <div>
             <div class="flex">
                 <label for="" class="com-label"><span class="com-star">*</span>上传图标</label>
                 <input class="com-txt flex-1" :class="{err:this.err.MTestUrl}" v-model="form.MTestUrl">
             </div>
             <div class="flex">
                 <label for="" class="com-label apply_2_label"><span class="com-star">*</span>应用描述</label>
                 <div class="flex-1"><textarea class="com-textarea"></textarea>
                    <div class="com-tip">在小程序专区展示给客户看，25字以内</div>
                 </div>
             </div>
             <div class="flex">
                 <label for="" class="com-label apply_2_label">附件</label>
